...
Bump the version (`vN`) in the marker comment above whenever the block content changes materially — the sync
script uses it to report which repos are stale.
